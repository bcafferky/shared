...
# Clear out the tags...
Set-AzureRmResource -Tag @{  } -Force -ResourceName $storagename -ResourceGroupName $resourcegroup -ResourceType Microsoft.Storage/storageAccounts

# Create new tags...
Set-AzureRmResource -Tag @{ Dept="IT"; Environment="Test" } -Force -ResourceName $storagename -ResourceGroupName $resourcegroup -ResourceType Microsoft.Storage/storageAccounts
...
Set-AzureRmResource -Tag $tags -Force -ResourceName $storagename -ResourceGroupName $resourcegroup -ResourceType Microsoft.Storage/storageAccounts
